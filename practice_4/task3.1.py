...
ax[0].plot(ts, theta_desireds, label=f'desired $\\theta^\\ast$ = {theta_desired-theta_home:.4f}')
ax[0].grid()
ax[0].set_title(f"Pendulum angle with inverted gravity under manual disturbances")
